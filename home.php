...
?>
	...
	<section class="section-2 section-white s-about bg-arcam-invert" id="home" >
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<span class="section__subtitle">Seja bem vindo a</span>
...
<!-- end about 1 section -->
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-8 align-middle">
					<div class="s-get-it-2__title">Pensando em importar?</div>
					<div class="s-get-it-2__title">Seu lugar é aqui, trazemos o mundo até você!</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-4 align-middle">
					<a class="btn-a btn-a_size_large btn-a_weight_bold" href="contato.php">Faça contato!</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="google-maps ">
		<div class="google-maps__container parallax" data-google-maps-coords="-22.9344726, -42.8373701" data-parallax-min-fading="90" data-parallax-speed="1"></div>
	</div>
