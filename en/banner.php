		...
		<div class='container'>
			<div class='main-5-slider-content'>
				<div class='main-5-slider-text'>
					...
					<div class='main-5-slider-text__subtitle'>Wholesale</div>
				</div>
				<div class='main-5-slider-text'>
					<div class='main-5-slider-text__subtitle hidden'>Machines and equipment</div>
				</div>
				<div class='main-5-slider-text'>
					<div class='main-5-slider-text__subtitle hidden'>
						Automotive parts for a range of brands and its various models.<br>
						Come and join the Arcam Brasil!
					</div>
				</div>
			</div>
		</div>
